...
class GeoDataProcessor:
    ...
    def load_data(self):
        ...
        with open("gebref.txt", "r", encoding="utf-8") as file:
            ...
            for chunk in tqdm(
                ...
                if len(chunk.columns) != len(expected_columns):
                    ...
                    raise ValueError(
                        "Fehlerhafte Zeile gefunden. Programm wird beendet."
                    )
                chunks.append(chunk)
        ...
        self.gdf = self.gdf.set_crs(
            "EPSG:25832"
        )  # Setzen des Koordinatensystems EPSG:25832
        self.gdf = self.gdf.to_crs(
            "EPSG:31466"
        )  # Transformieren in das gewünschte Koordinatensystem EPSG:31466
        print(self.gdf)
    ...
    def save_data(self):
        ...
        for value in unique_gmd_values:
            ...
            print(
                f"Gefilterte und sortierte Daten für '{value}' wurden in '{filename}' gespeichert."
            )
    ...
    while True:
        ...
        if current_page < total_pages - 1:
            ...
            if next_page.lower() == "q":
                ...
                console.print(
                    Panel(
                        "Ungültige Eingabe. Bitte versuchen Sie es erneut.", style="red"
                    )
                )
            current_page += 1
        else:
